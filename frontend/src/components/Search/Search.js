...
const Search = ({setKeyword,handlesubmit,keyword}) => {
  ...
  return (
    <div className="searchinput text-center mx-2 mb-4">
            <Form onSubmit={handlesubmit} >
                <Form.Group as={Row} className="d-flex justify-content-center ms-4">
                    <Col md="6">
                        <InputGroup>
                                 <Form.Control placeholder="search a product by name" onChange={(e)=> setKeyword(e.target.value)} name="search" value={keyword} />
